  ...
  const projects = [
    {
      ...
      description:
        "My first project built on the web. It is a sushi restaurant that is supposed to give the user a sense that they are in the restaurant. My focus for this project was to ",
      tags: [
        {
          name: "HTML",
