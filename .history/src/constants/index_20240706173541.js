...
import {
  ...
  const projects = [
    ...
    },
    {
      name: "SeeThrough",
      description:
        "A flask application that scrapes posts from Reddit based on the user's queries. Utilziing PRAW to interact with the Reddit API to fetch posts based on criterias. Can display different medias such as images, gifs, and videos. Streamlines content by only displaying 1 post at a time and logs the additional posts",
      tags: [
        {
          name: "react",
          color: "blue-text-gradient",
