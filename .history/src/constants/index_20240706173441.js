...
import {
  ...
  const projects = [
    ...
    },
    {
      name: "SeeThrough",
      description:
        "A flask application that scrapes posts from Reddit based on the user's queries. Utilziing PRAW to interact with the Reddit API to fetch posts based on criterias. Can display different",
      tags: [
        {
          name: "react",
          color: "blue-text-gradient",
